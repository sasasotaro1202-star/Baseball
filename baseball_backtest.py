        ...
        def _context_row_is_safe(rr: pd.Series, kind: str) -> tuple[bool, bool]:
            try:
                ...
                if kind == "starter":
                    ...
                    available = pd.to_datetime(rr.get("starter_available_at"), errors="coerce", utc=True)
                ...
                home_available = pd.to_datetime(rr.get("home_lineup_available_at"), errors="coerce", utc=True)
                away_available = pd.to_datetime(rr.get("away_lineup_available_at"), errors="coerce", utc=True)
