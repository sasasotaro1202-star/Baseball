...
class BaseballBacktest:
    def __init__(self, data_dir: Path = DATA):
        ...
        self.checkpoint_version = "npb-massive-resume-v2"
    ...
    def starter_features(self, league: str, pitcher: str, dt: pd.Timestamp, prefix: str) -> Dict[str, float]:
        ...
        if not hist:
            ...
            return {
                ...
                prefix + "recent_k9": 7.5, prefix + "recent_k_rate": 0.20,
                prefix + "recent_pitches": 0.0, prefix + "recent_ip": 0.0,
            }
        ...
        return {
            ...
            prefix + "recent_pitches": ravg("pitches",0.0), prefix + "recent_ip": ravg("ip",0.0),
        }
