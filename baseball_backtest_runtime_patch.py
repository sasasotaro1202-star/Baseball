...
s='# BACKTEST_RUNTIME_HARDENING_V3\n'+s
P.write_text(s,encoding='utf-8')
print('[BACKTEST PATCH] V3 applied: NPB normalizer with JST-safe datetimes + starter metadata + pitcher history')
