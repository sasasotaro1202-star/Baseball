...
def test_context_readiness_uses_only_prior_pit_safe_rows():
    import pandas as pd
    from baseball_backtest import BaseballBacktest
    ...
    # Rows 0-29 must not receive starter-derived context because they do not
    # have 30 prior valid PIT-safe observations. Row 30 is the first eligible row.
    ...
    assert bt.core_context_training_ready["starter"] is True
