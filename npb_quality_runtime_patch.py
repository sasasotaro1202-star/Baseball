...
MARK="# NPB_QUALITY_HARDENING_V1"
if MARK in s:
    print("[NPB QUALITY PATCH] V1 already applied")
    raise SystemExit(0)

# Empty schedules are transient source failures unless an explicit checkpoint
# already exists; neither case should be silently promoted to a completed season.
...
print('[NPB QUALITY PATCH] V1 applied')
